...
export default function HomeV2() {
  ...
  return <>
      ...
      <section className="min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-6">
        <motion.div className="text-center space-y-6 max-w-4xl bg-black/1 backdrop-blur-sm rounded-xl p-8 md:p-12 px-0" initial={{
        opacity: 0,
        y: 30
      }} animate={{
        opacity: 1,
        ...
        ease: "easeOut"
          ...
          <motion.h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-medium tracking-wide text-white drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          <motion.p className="text-base sm:text-lg md:text-xl lg:text-2xl font-normal leading-relaxed text-white/95 max-w-3xl mx-auto" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          {/* CTA Buttons */}
          <motion.div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 sm:pt-6" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
